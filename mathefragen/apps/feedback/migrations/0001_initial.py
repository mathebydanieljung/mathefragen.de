    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('youtube', 'Youtube Channel'), ('app', 'App'), ('website', 'Webseite'), ('book', 'Buch')], default='', max_length=20)),
                ('description', models.TextField()),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='learntool_suggestions', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
